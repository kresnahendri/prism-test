...
class Ion_auth
{
	...
	public function is_purchase($id=false)
	{
		$this->ion_auth_model->trigger_events('is_purchase');

		$purchase_group = $this->config->item('purchase_group', 'ion_auth');

		return $this->in_group($purchase_group, $id);
	}

	public function is_sale($id=false)
	{
		$this->ion_auth_model->trigger_events('is_sale');

		$sale_group = $this->config->item('sale_group', 'ion_auth');

		return $this->in_group($sale_group, $id);
	}
